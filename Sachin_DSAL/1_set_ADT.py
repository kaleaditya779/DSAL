...
def menu():
    ...
    while True:
        ...
        print("4. Check if element is in Set 1")
        print("5. Get size of Set 1")
        print("6. Perform intersection of Set 1 and Set 2")
        print("7. Perform union of Set 1 and Set 2")
        print("8. Get difference between Set 1 and Set 2")
        print("9. Check if Set 1 is a subset of Set 2")
        print("10. Display Set 1")
        print("11. Display Set 2")
        print("12. Exit")
        ...
        if choice == 1:
            ...
            print(set_1.elements)
        elif choice == 11:
            print(set_2.elements)
        elif choice == 12:
